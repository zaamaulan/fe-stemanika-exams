    ...
    <main className="flex flex-col px-6 md:items-center xl:px-0">
      ...
      <section className="py-10 xl:px-40 xl:py-20 ">
        <div className="min-w-sm w-full">
          ...
          <p className="mb-6 text-xs text-gray-500 xl:mb-14 xl:text-center xl:text-base">
      ...
      {daftarUjian ? (
        <section className="py-10 xl:flex  xl:flex-col xl:items-center xl:px-40 xl:py-20">
          <div className="min-w-sm mb-6 w-full xl:mb-14">
            ...
            <p className="mb-6  text-xs text-gray-500 xl:text-base">Mari Bersiap, Pekan Ini Penuh Keajaiban Belajar!</p>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-10 xl:grid-cols-3">
                  ...
                  >
                    <Card>
                      <div className="mb-10">
                        ...
                        <p className={`mb-6 line-clamp-3 text-xs text-gray-500`}>{ujian.attributes.deskripsi}</p>
                      </div>
                      <div>
              ...
              >
                <Card>
                  <div className="mb-10">
                    ...
                    <p className={`mb-6 line-clamp-3 text-xs text-gray-500`}>
                  ...
                  <div>
                    ...
                    <p className="mb-2 text-xs font-medium text-black">Durasi Pengerjaan: 60 menit</p>
                  </div>
                </Card>
              </motion.div>
              <motion.div
      ...
      <section className="py-10 xl:flex  xl:flex-col xl:items-center xl:px-40 xl:py-20">
        <div className="min-w-sm mb-6 w-full xl:mb-14">
          ...
          <p className="mb-6 text-xs text-gray-500 xl:text-base">
                ...
                <Card className={'flex h-full flex-col items-center justify-center'}>
                  <div className="mb-4">
                    ...
                    <div>
                      ...
                      <p className="mb-5 text-xs text-gray-500 xl:mb-5 xl:text-base">
                    ...
                    <div>
                      ...
                      <p className=" text-xs text-gray-500 xl:text-base">
