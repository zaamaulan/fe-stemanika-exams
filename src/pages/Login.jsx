...
const Login = () => {
  ...
  return (
    <main className="mx-auto grid h-screen max-w-md scale-[0.85] select-none place-items-center md:scale-100">
      <Card className={'h-fit'}>
        <div className="mb-10">
          <h1 className="mb-2 text-3xl font-bold">Log In</h1>
          <p className="text-gray-500">Enter your username and password to login.</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="relative flex flex-col">
            ...
            <input
              ...
              id="password"
              className=" border-input bg-background flex h-10 w-full rounded-md border px-3 py-2 pr-14 text-sm focus:outline-none"
            />
            <span
              onClick={() => {
                setShowPassword(!showPassword)
              }}
              className="absolute right-5 translate-y-10 transform cursor-pointer"
            >
              {showPassword ? (
                <svg
